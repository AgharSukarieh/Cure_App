...
import { get, isLoadingIndicatorVisible, post } from "../../WebService/RequestBuilder";
				...
				<View style={style.ModalView}>
					...
					<ScrollView showsVerticalScrollIndicator={false}>
						<View style={{ marginVertical: 10 }}>
							<View style={style.card}>
								...
								<SelectDropdown
									...
									renderDropdownIcon={isOpened => {
										return <Feather name={isOpened ? "chevron-up" : "chevron-down"} color="#000"
														size={13} style={{ marginLeft: 0 }} />;
									}}
							...
							<View style={style.card}>
								<TouchableOpacity disabled={pharam != "" ? false : true} style={{
									...styles.btn,
									backgroundColor: pharam != "" ? "#469ED8" : "#ddd",
								}} onPress={() => {
									submit2();
								}}>
									<Text style={{

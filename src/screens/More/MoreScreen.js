...
const MoreScreen = () => {
  ...
  const handleLogout = async () => {
    try {
      ...
      alert.showError('خطأ', 'حدث خطأ أثناء تسجيل الخروج');
    }
  };
  ...
  return (
    <>
      ...
      >
        ...
        <Image 
          source={
            user?.profile_image_url || user?.medicals?.profile_image
...
<Text style={[ {   color: "#f0f0f0",
  ...
  {t('userCard.email')}
            ...
            <View style={styles.detailRow}>
                ...
                <Text style={[styles.detailValue, isRTL && styles.rtlText]}>{user?.distributor_name || 'غير محدد'}</Text>
            </View>
        </View>
      ...
      <Pressable style={[styles.listItem, darkMode && styles.darkListItem]} onPress={handleTermsPress}>
      ...
      <Pressable style={[styles.listItem, darkMode && styles.darkListItem]} onPress={handlePrivacyPress}>
